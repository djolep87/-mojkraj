...
@section('title', 'Prijava za pravna lica - Moj Kraj')
        ...
        <div class="bg-white/80 backdrop-blur-lg rounded-2xl shadow-2xl border border-white/20 overflow-hidden">
            ...
            <div class="bg-gradient-to-r from-green-600 to-emerald-600 px-8 py-12 text-center">
                ...
                <p class="text-green-100">
                    Prijavite se da upravljate svojim biznisom
                </p>
            </div>

            <!-- Form -->
            <div class="px-8 py-8">
                <form class="space-y-6" action="{{ route('business.login') }}" method="POST">
                    @csrf
                ...
                <div class="mt-6 text-center">
                    <p class="text-sm text-gray-600">
                        Nemate business nalog? 
                        <a href="{{ route('business.register') }}" class="font-semibold text-green-600 hover:text-green-500 transition-colors duration-200">
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <p class="text-sm text-blue-800">
                                ...
                                <a href="{{ route('login') }}" class="font-semibold text-blue-600 hover:text-blue-500 ml-1 transition-colors duration-200">
                                    Prijavite se kao obični korisnik
                                </a>
                            </p>
                        </div>
                    </div>

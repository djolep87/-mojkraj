        ...
        <form class="mt-8 space-y-6" method="POST" action="{{ route('register') }}">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <input id="name" name="name" type="text" required 
                           ...
                           placeholder="Unesite ime i prezime" value="{{ old('name') }}">
                    @error('name')
                ...
                <div>
                    <label for="neighborhood" class="block text-sm font-medium text-gray-700">Komšiluk/Deo grada</label>
                    <input id="neighborhood" name="neighborhood" type="text" required 
                           class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('neighborhood') border-red-500 @enderror" 
                           placeholder="Unesite komšiluk ili deo grada" value="{{ old('neighborhood') }}">
                    @error('neighborhood')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="city" name="city" type="text" required 
                           class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('city') border-red-500 @enderror" 
                ...
                <div>
                    ...
                    <input id="postal_code" name="postal_code" type="text" 
                           class="mt-1 appearance-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-md focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm @error('postal_code') border-red-500 @enderror" 
                           placeholder="Unesite poštanski broj" value="{{ old('postal_code') }}">
                    @error('postal_code')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="text-center">
                <p class="text-sm text-gray-600">
                    Imate biznis? 
                    <a href="{{ route('business.register') }}" class="font-medium text-green-600 hover:text-green-500">

...
@section('title', 'Lista biznisa u vašem komšiluku - Moj Kraj')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-8">
            ...
            <p class="text-gray-600">
                Otkrijte lokalne kompanije i usluge u {{ $user->neighborhood }}, {{ $user->city }}
            </p>
        </div>

        <!-- Filters and Search -->
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
            <form method="GET" action="{{ route('businesses.list') }}" class="space-y-6">
                <!-- Search Bar -->
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Pretraži po nazivu kompanije, kontakt osobi ili opisu..."
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select name="business_type" id="business_type" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                    ...
                    <div>
                        ...
                        <select name="sort" id="sort" class="block w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500">
                            ...
                            <option value="name" {{ request('sort') == 'name' ? 'selected' : '' }}>Naziv A-Z</option>
                        </select>
                    </div>
                </div>
                    ...
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 hover:shadow-lg transition-shadow duration-300 overflow-hidden">
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex space-x-2">
                                <a href="{{ route('offers.index', ['business_user' => $business->id]) }}" 
                                   class="flex-1 bg-blue-600 text-white text-center py-2 px-4 rounded-lg font-medium hover:bg-blue-700 transition-colors duration-200">
                                    Pogledaj ponude
                                </a>
                                @if($business->phone)
                                    <a href="tel:{{ $business->phone }}" 
                                       class="bg-green-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-green-700 transition-colors duration-200 flex items-center justify-center">
